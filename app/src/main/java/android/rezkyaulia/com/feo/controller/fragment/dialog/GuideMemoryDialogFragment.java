...
import android.rezkyaulia.com.feo.databinding.ContentGuideMemoryBinding;
...
public class GuideMemoryDialogFragment extends DialogFragment {
    public final static String Dialog= "DIALOG";
    public final static int TARGET = 1;
    public final static String ARG1 = "arg1";

    ContentGuideMemoryBinding binding;

    private UserTbl mUserTbl;
    private String mWords;

    public static GuideMemoryDialogFragment newInstance(){
        GuideMemoryDialogFragment dialogFragment = new GuideMemoryDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding =  DataBindingUtil.inflate(inflater, R.layout.content_guide_memory,container,false);
